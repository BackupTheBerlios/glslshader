...
/**
 * This will push the current program on the stack.
 **/
void glslPush(){
...
/**
 * This will restore the last pushed program from the stack
 */
void glslPop(){
...
/**
 * Enable adn bind the program for using in the next rendering steps.
 * @param obj SHader program created before.
 **/
